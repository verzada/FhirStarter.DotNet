...
using FhirStarter.STU3.Detonator.DotNetCore3.SparkEngine.Service.FhirServiceExtensions;
using FhirStarter.STU3.Instigator.DotNet.Model;
using FhirStarter.STU3.Instigator.DotNet.Validation;
...
namespace FhirStarter.STU3.Instigator.DotNet.Helper
{
    public static class ControllerHelper
    {
        ...
        private static string GetFhirVersion(string version)
        {
            switch (version)
            {
             default:
